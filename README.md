...
To install the plugin copyt the file running-free.php directly to your wordpress wp-content/plugins folder. Then go to the Dashboard/Plugins and activate the plugin. That's it. Enjoy working with Wordpress. 
